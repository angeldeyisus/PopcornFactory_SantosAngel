...
class ListaPeliculas : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun cargarPeliculas() {
            ...
            peliculas.add(Pelicula("1917", R.drawable.milnuevediecisiete, R.drawable.milnuevediecisieteheader, "British trenches somewhere in France. World war has been going on for the third year,\n" +
    ...
    class PeliculaAdapter: BaseAdapter {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            vista.findViewById<ImageView>(R.id.iv_pelicula).setImageResource(pelicula.imagen)
